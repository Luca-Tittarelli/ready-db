                ...
                tables: [
                    ...
                    },
                    {
                        ...
                        columns: [
                            ...
                            { id: messagesId + '-c5', name: 'sent_at', type: 'timestamp', pk: false, nullable: false, defaultValue: 'now()' },
                        ]
                    },
                ],
                connections: [
        ...
        build: () => {
            ...
            return {
                tables: [
                    ...
                    {
                        id: sprintsId, name: 'sprints', x: 800, y: 300, color: '#FF2D55',
                        columns: [
                ...
                tables: [
                    {
                        ...
                        columns: [
                            ...
                            { id: usersId + '-c2', name: 'user_id', type: 'varchar(255)', pk: false, nullable: true },
                    ...
                    },
                    {
                        ...
                        columns: [
                            ...
                            { id: eventsId + '-c4', name: 'timestamp', type: 'timestamp', pk: false, nullable: false, defaultValue: 'now()' },
                        ]
                    },
                    {
                        ...
                        columns: [
                            ...
                            { id: pagesId + '-c5', name: 'timestamp', type: 'timestamp', pk: false, nullable: false, defaultValue: 'now()' },
                        ]
                    },
                ],
                connections: [
